...
import com.ch.aidu.weight.animation.CoverPageAnim;
import com.ch.aidu.weight.animation.HorizonPageAnim;
import com.ch.aidu.weight.animation.NonePageAnim;
import com.ch.aidu.weight.animation.PageAnimation;
import com.ch.aidu.weight.animation.ScrollPageAnim;
import com.ch.aidu.weight.animation.SimulationPageAnim;
import com.ch.aidu.weight.animation.SlidePageAnim;
...
public class PageView extends View {
    ...
    //内容加载器
    private LocalPageLoader mPageLoader;
    ...
    //获取PageLoader
    public LocalPageLoader getPageLoader(boolean isLocal) {
        if (mPageLoader == null) {
            if (isLocal) {
